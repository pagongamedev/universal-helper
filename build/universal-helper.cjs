...
__export(src_exports, {
  ...
  helperEvent: () => event_exports,
  helperI18Next: () => i18next_exports,
  helperPWA: () => pwa_exports,
  helperPromise: () => promise_exports,
  helperReact: () => react_exports,
  helperScreen: () => screen_exports,
  helperTailwind: () => tailwind_exports,
  helperTime: () => time_exports,
  helperType: () => type_exports,
